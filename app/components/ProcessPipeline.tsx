    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="flex justify-center mb-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl">
          {/* TikTok */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-200 shadow-md hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-purple-900 text-sm">TikTok</h4>
          ...
          <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-4 rounded-lg border-2 border-pink-200 shadow-md hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-pink-900 text-sm">Instagram</h4>
              <div className="flex justify-center mt-2">
