    ...
    <div className="bg-white rounded-xl shadow-2xl p-6 transform hover:-translate-y-1 transition-all duration-300">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 space-y-4 sm:space-y-0">
        ...
        <div className="flex space-x-2 justify-center sm:justify-end">
          <button className="text-sm text-gray-500 hover:text-gray-700 px-3 py-1">Daily</button>
          <button className="text-sm bg-purple-100 text-purple-600 px-3 py-1 rounded-full">Weekly</button>
          <button className="text-sm text-gray-500 hover:text-gray-700 px-3 py-1">Monthly</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-50 rounded-lg p-4 text-center sm:text-left">
          ...
          <p className="text-2xl font-bold text-gray-900 mb-2">8.7%</p>
          <div className="flex items-center justify-center sm:justify-start">
            <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
            <span className="text-sm text-green-500 ml-1 font-medium">+2.4%</span>
          </div>
        </div>
        <div className="bg-gray-50 rounded-lg p-4 text-center sm:text-left">
          <p className="text-sm text-gray-500 mb-2">Click-Through Rate</p>
          <p className="text-2xl font-bold text-gray-900 mb-2">4.2%</p>
          <div className="flex items-center justify-center sm:justify-start">
            <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
            <span className="text-sm text-green-500 ml-1 font-medium">+1.8%</span>
          </div>
        </div>
        <div className="bg-gray-50 rounded-lg p-4 text-center sm:text-left">
          <p className="text-sm text-gray-500 mb-2">Conversion Rate</p>
          <p className="text-2xl font-bold text-gray-900 mb-2">2.8%</p>
          <div className="flex items-center justify-center sm:justify-start">
            <svg className="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
            <span className="text-sm text-green-500 ml-1 font-medium">+3.1%</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between bg-white p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-gray-900">Weekend Special</span>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center justify-between bg-white p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-gray-900">Weather Campaign</span>
            </div>
            <div className="flex items-center space-x-4">
